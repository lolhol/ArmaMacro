...
public class lookAtSlowly {
    ...
    public static void lookAtSlowly(double x, int y, double z) {
        ...
        mc.thePlayer.rotationYaw += hoekYaw * lookSpeed;
        hoekPitch =
                radToDegree.radToDegree(Math.atan(dy / dist)) - mc.thePlayer.rotationPitch;
        mc.thePlayer.rotationPitch += hoekPitch * lookSpeed;
    }
}
